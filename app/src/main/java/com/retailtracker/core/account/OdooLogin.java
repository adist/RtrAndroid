...
import com.retailtracker.OdooActivity;
import com.retailtracker.R;
import com.retailtracker.base.addons.res.ResCompany;
import com.retailtracker.config.FirstLaunchConfig;
...
import com.retailtracker.core.support.OdooInstancesSelectorDialog;
import com.retailtracker.core.support.OdooUserLoginSelectorDialog;
import com.retailtracker.core.utils.IntentUtils;
import com.retailtracker.core.utils.OResource;
import com.retailtracker.datas.OConstants;
...
//                IntentUtils.openURLInBrowser(this, OConstants.URL_ODOO_SIGN_UP);
    ...
    private void toggleCreateAccount() {
        TextView txvCreateAccount = (TextView) findViewById(R.id.create_account);
        if (!mCreateAccount) {
            mCreateAccount = true;
